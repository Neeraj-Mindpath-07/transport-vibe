...
export function ReviewSortSelect({ value, onChange, className }: ReviewSortSelectProps) {
  ...
  return (
    <div ref={rootRef} className={cn("relative", className)}>
      <button
        type="button"
        className="inline-flex h-11 min-w-[180px] items-center justify-between gap-2 rounded-lg border border-neutral-200 bg-neutral-0 px-3 text-body-sm text-text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
            ...
            return (
              <li key={option.value} role="presentation">
                <button
                  ...
                  className={cn(
                    "flex w-full items-center px-3 py-2 text-left text-body-sm transition-colors hover:bg-neutral-100",
